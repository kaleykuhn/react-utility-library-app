export const uiData = [
   ...
   },
   {
      name: "standInLine",
      desc:
         "Add number to end of array,remove first element and show that removed element in return",
      inputs: 2,
      type: "basic",
      typeNum: 100,
      isFavorite: false,
   ...
   },
   {
      ...
      desc:
         "Use higher order functions map,filter, or reduce to solve complex problem",
      inputs: 1,
      type: "Functional",
      typeNum: 300,
      isFavorite: false,
   ...
   },
   {
      name: "sentisify",
      desc:
         "Join the elements of an array to create a string using join method.",
      inputs: 1,
      type: "Functional",
      typeNum: 300,
      isFavorite: true,
   ...
   },
   {
      ...
      desc:
         "Use the some method to check if any element in array meets criteria",
      inputs: 1,
      type: "Functional",
      typeNum: 300,
      isFavorite: false,
